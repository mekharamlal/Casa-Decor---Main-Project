                    ...
                    ?>
                        <div class="cart-item-container">
                            ...
                            <div class="cart-info quantity" style="margin-left: -16%;">
                                <div class="btn-increment-decrement" onClick="decrement_quantity(<?php echo $item["cart_id"]; ?>, '<?php echo $item["product_price"]; ?>')">-</div><input class="input-quantity" id="input-quantity-<?php echo $item["cart_id"]; ?>" value="<?php echo $item["quantity"]; ?>">
                                <div class="btn-increment-decrement" onClick="increment_quantity(<?php echo $item["cart_id"]; ?>, '<?php echo $item["product_price"]; ?>')">+</div>
                            </div>
                            ...
                            <div class="cart-info action">
                                <a href="shopping.php?action=remove&id=<?php echo $item["cart_id"]; ?>" class="btnRemoveAction">
